...
面试官您好，我是湖南师范大学软件工程专业的本科生，目前大四，
我平时主要使用Java进行后端开发，通过在校期间的学习掌握了常见的数据结构与算法基础，
也比较熟悉计算机网络和操作系统的一些核心概念，
我在开发过程中也比较多地使用AI工具来提升效率，比如使用Copilot、opencode、
codex辅助生成代码、编写测试用例，以及进行代码优化和重构，这让我在学习新技术和切换语言时效率比较高。
我个人比较喜欢钻研技术，对新技术有持续的学习兴趣，也希望能在实际工程中不断提升自己的能力。
我的介绍大概就是这些，谢谢。

## HR版

面试官您好，我是湖南师范大学软件工程专业的应届毕业生。非常感谢您给我这次面试机会。
我在校期间系统地学习软件开发的相关课程，掌握了扎实的编程基础和软件开发技能，并且通过多个项目实践，积累了一定的实际开发经验。
我认为自己最大的三个特点是：快速学习能力、解决问题的韧性，以及良好的团队协作意识。
我选择应聘贵公司的Java开发岗位，是因为我的技术兴趣与贵公司的移动互联网业务非常契合。
我相信贵公司能让我在实战中快速成长，并为我未来的技术发展提供一个优秀的平台。
以上就是我的简要介绍，谢谢！
